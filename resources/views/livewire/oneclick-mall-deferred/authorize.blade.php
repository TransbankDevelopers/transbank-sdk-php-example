<div>
    <div class="tbk-card">
        ...
        <form wire:submit.prevent="authorizeTransaction">
            ...
            <div class="input-container mb-32">
                <label for="buyOrder" class="tbk-label">Orden de compra mall</label>
                <input type="text" wire:model="buyOrder" name="buyOrder" class="tbk-input-text" required>
            </div>

            <!-- Tienda 1 -->
            <div class="tbk-section">
            ...
            <!-- Tienda 2 -->
            <div class="tbk-section mb-32" x-data="{ show: false }" x-init="$watch('show', value => {
                if (!value) {
                    $wire.set('commerceCode2', '');
                    $wire.set('buyOrder2', '');
                    $wire.set('amount2', '');
                    $wire.set('installments2', '');
                }
            })">
                <div x-show="show">
