...
<x-layout active-link="Webpay Mall Diferido" :navigation="$navigation">
    <div class="breadcrumbs-container">
        ...
        <div class="breadcrumbs-items">
            <a class="current-breadcrumb" href="/webpay-mall-diferido/status?token={{ $req['token'] }}">Consultar estado
                de transacción</a>
        </div>
    </div>
    <h1>Webpay Mall Diferido- Consultar estado de transacción</h1>
