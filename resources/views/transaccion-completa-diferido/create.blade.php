...
<x-layout active-link="Transacción Completa Diferido" :navigation="$navigation">
    <div class="breadcrumbs-container">
        ...
        <div class="breadcrumbs-items">
            <a class="current-breadcrumb" href="/transaccion-completa-diferido/create">Crear Transacción</a>
        </div>

    </div>

    <h1>Transacción Completa Diferido - Crear transacción</h1>
    ...
    <x-snippet>
        ...
        $response = $transaction->create($buyOrder, $sessionId, $amount, $cardNumber, $cardExpiry, $cvv);
    </x-snippet>
    ...
    <form action="{{ route('transaccion-completa-diferido.installments') }}" method="POST">
        @csrf
        <div class="tbk-card">
            ...
            <div class="tbk-card-footer">
                ...
                <a href="{{ route('transaccion-completa-diferido.commit', ['token' => $respond->token]) }}"
