...
<x-layout active-link="Transacción Completa Diferido" :navigation="$navigation">
    <div class="breadcrumbs-container">
        ...
        <div class="breadcrumbs-items">
            <a class="current-breadcrumb" href="/transaccion-completa-diferido/commit">Confirmar</a>
        </div>

    </div>

    <h1>Transacción Completa Diferido - Confirmar transacción</h1>
    ...
    <x-snippet>
        ...
        $response = $transaction->commit($token, $idQueryInstallments, $deferredPeriodIndex, $gracePeriod);
    </x-snippet>

    <h2 id="response">Paso 2: Datos recibidos</h2>
    ...
    <form action="{{ route('transaccion-completa-diferido.capture') }}" method="GET">
        <div class="tbk-card">
            <div class="input-container mb-32">
                ...
                <input type="hidden" name="authorizationCode" value="{{ $respond->authorizationCode }}">
                <input type="hidden" name="buyOrder" value="{{ $respond->buyOrder }}">
