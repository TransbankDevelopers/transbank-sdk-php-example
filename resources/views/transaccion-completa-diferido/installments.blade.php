...
<x-layout active-link="Transacción Completa" :navigation="$navigation">
    <div class="breadcrumbs-container">
        ...
        <div class="breadcrumbs-items">
            <a class="current-breadcrumb" href="/transaccion-completa-diferido/installments">Consulta de cuotas</a>
        </div>

    </div>

    <h1>Transacción Completa Diferido - Consulta de cuotas</h1>
    ...
    <x-snippet>
        ...
        $response = $transaction->installments($token, $installments);
    </x-snippet>
    ...
    @push('scripts')
        <script>
            ...
            function updateLink() {
                ...
                confirmLink.href = "{{ route('transaccion-completa-diferido.commit') }}?" + params.toString();
            }
