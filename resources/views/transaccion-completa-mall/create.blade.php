...
<x-layout active-link="Transacción Completa Mall" :navigation="$navigation">
    <div class="breadcrumbs-container">
        ...
        <div class="breadcrumbs-items">
            <a class="current-breadcrumb" href="/transaccion-completa-mall/create">Crear Transaccion</a>
        </div>
    </div>

    <h1>Transacción Completa Mall - Crear Transaccion</h1>
    ...
    <x-snippet>
        ...
        $details = [
            [
                "amount" => 1000,
                "commerce_code" => TransaccionCompleta::INTEGRATION_MALL_CHILD_COMMERCE_CODE_1,
                "buy_order" => "O-123"
            ],
            [
                "amount" => 1000,
                "commerce_code" => TransaccionCompleta::INTEGRATION_MALL_CHILD_COMMERCE_CODE_2,
                "buy_order" => "O-456"
            ]
        ];
    ...
    <form action="{{ route('transaccion-completa-mall.installments') }}" method="POST">
        @csrf
        <div class="tbk-card">
            ...
            <div class="tbk-card-footer">
                ...
                <a href="{{ route('transaccion-completa-mall.commit', ['token' => $respond->token]) }}"
