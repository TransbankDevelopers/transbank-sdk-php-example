...
<x-layout active-link="Oneclick Mall Diferido" :navigation="$navigation">
    <div class="breadcrumbs-container">
        ...
        <div class="breadcrumbs-items">
            <a href="/oneclick-mall-diferido/start">Oneclick Mall</a>
            <img src={{ asset('images/t-arrow.svg') }} alt="t-arrow" width="24" height="24" />
        </div>
        <div class="breadcrumbs-items">
            <a class="current-breadcrumb" href="/oneclick-mall-diferido/status?buyOrder={{ $buyOrder }}">Consultar
                estado de
                transacción</a>
        </div>
    </div <h1>Oneclick Mall Diferido - Consultar estado de transacción</h1>
