...
<x-layout active-link="Transacción Completa Mall Diferido" :navigation="$navigation">
    <div class="breadcrumbs-container">
        ...
        <div class="breadcrumbs-items">
            <a class="current-breadcrumb" href="/transaccion-completa-mall-diferido/status">Estado de transacción</a>
        </div>
    </div>

    <h1>Transacción Completa Mall Diferido - Estado de transacción</h1>
